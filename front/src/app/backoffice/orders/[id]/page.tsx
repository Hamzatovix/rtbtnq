...
export default function OrderDetailPage() {
  ...
  if (!order) return (
    <div className="space-y-4">
      ...
      <p className="text-fintage-graphite/60 dark:text-fintage-graphite/75 font-mono text-xs uppercase tracking-[0.15em]">Заказ не найден</p>
    </div>
  )
              ...
              <ul className="space-y-2 text-sm">
                {order.events.map((e:any)=> (
                  <li key={e.id} className="flex justify-between">
                    <span className="text-fintage-graphite/60 dark:text-fintage-graphite/75 font-mono text-xs">{new Date(e.createdAt).toLocaleString()}</span>
          ...
          <div className="p-6 border border-fintage-graphite/20 dark:border-fintage-graphite/45 rounded-sm shadow-fintage-sm">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between">
                <span className="text-fintage-graphite/60 dark:text-fintage-graphite/75">Сумма:</span>
                <span className="font-medium text-fintage-charcoal dark:text-fintage-offwhite">{order.total}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-fintage-graphite/60 dark:text-fintage-graphite/75">Платёж:</span>
                <span className="text-fintage-charcoal dark:text-fintage-offwhite">{order.paymentStatus || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-fintage-graphite/60 dark:text-fintage-graphite/75">Доставка:</span>
                <span className="text-fintage-charcoal dark:text-fintage-offwhite">{order.fulfillmentStatus || '-'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-fintage-graphite/60 dark:text-fintage-graphite/75">Статус:</span>
