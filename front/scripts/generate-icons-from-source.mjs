 ...
 */
async function createIcon(size, safeAreaPercent = 0.65) {
...
async function generateIcons() {
  try {
    ...
    const appleIcon = await createIcon(180, 0.65)
    ...
    const icon192 = await createIcon(192, 0.65)
    ...
    const icon512 = await createIcon(512, 0.65)
